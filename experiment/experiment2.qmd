...
<!-- - DC-3: X, X, X, the rest in the division by 200 is `r dc3 %% 200`, which is the threshold amount (in cents). The first number is above/below 5, so the question used is the first/second.-->
